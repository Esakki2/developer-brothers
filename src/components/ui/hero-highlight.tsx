...
export const HeroHighlight = ({
  ...
  // Only using dark theme pattern for a fully dark layout
  const dotPattern = {
...
>
      ...
      <div
        ...
        style={{ backgroundImage: dotPattern.default }}
      />
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        "relative inline-block rounded-lg bg-gradient-to-r from-[#5a5aff] to-[#967eff] px-1 pb-1",
        className
      )}
    >
      {children}
